...
def run_simulation_ramp_open(sumoBinary = "sumo-gui", total_sim_step = 7200, control_interval = 120, warning = True, files_out_dict = "Loop_Data_Ramp_Open/"):
    """
    :param total_sim_step:
    :param control_interval: ramp metering control step
    :param green_duation:
...
def run_simulation_random(sumoBinary = "sumo-gui", total_sim_step = 7200, control_interval = 180, green_duration = 5, min_rate = 0.1, max_rate = 1, warning = True, files_out_dict ="Loop_Data_Ramp_Random/"):
    """
    :param total_sim_step:
    :param control_interval: ramp metering control step
    :param green_duation:
