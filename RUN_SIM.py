...
def run_simulation_random(total_sim_step = 7200, control_interval = 180, green_duration = 5, min_rate = 0.1, max_rate = 1, warning = True, files_out_dict ="Loop_Data_Ramp_Random/"):
    """
